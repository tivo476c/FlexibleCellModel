...
NumberOfCells = 50                         # number of cells [OLD NAME: "M"] TODO: change to 400
M = NumberOfCells
...
NumberOfSimulations = 3 # TODO: change to 300 or something like this (test how many!!!)
NumberOfSampleTimes = length(sampleTimes) 
#simulationName = string("run1-NoSim", NumberOfSimulations, "-T",timeInterval[2]) 
simulationName = string("point-particle-model-development-1.0") 
