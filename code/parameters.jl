...
## Force scalings: 
hardness = 0 / 20                                       # tells how hard the cells are hardness =1 for hard cells, hardness =0 for soft cells, or something in between 

areaForceFactor = (1 - hardness) * 5e7 + hardness * 1e9
edgeForceFactor = (1 - hardness) * 5e2 + hardness * 5e4
interiorAngleForceFactor = (1 - hardness) * 5e1 + hardness * 1e2
...
NumberOfSampleTimes = 201          # must be 2 at least
...
# simulationName = "showOverlap-hardness$(hardness)-semihardshape"
simulationName = "test-simgif"
# simulationName = "$(floor(Int64, log10(areaForceFactor)))-$(floor(Int64,log10(edgeForceFactor)))-$(floor(Int64, log10(interiorAngleForceFactor)))-$(floor(Int64,log10(overlapForceFactor)))"
