...
- As shown in Figure~\ref{fig:?}, our simulation results for the point particle model closely match those presented in~\cite{Bruna2012}, confirming the accuracy of our implementation. 
...
Figure~\ref{fig:?} shows the results of our Monte Carlo simulation for the hard DF model at different time steps.
- The result looks similar to those from ~\cite{Bruna2012}, confirming that our DF model can accurately replicate the behaviour of hard sphere cells when shape deformation is disabled. 
