...
% The heatmaps in Chapter~\ref{sanitycheck} are obtained by evaluating this empirical measure on a family of subsets $\{A_{ij}\}_{i,j=1}^{N_H}$, where $N_H^2$ is the number of subsquares into which we partition the domain $\Omega = [-0.5, 0.5]^2$.  
