...
\begin{figure}[h!]
    ...
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t1.png} &    
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t2.png} &  
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t3.png} \\   

        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t4.png} &    
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t5.png} &  
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/histograms/histogram_t6.png} \\    
    \end{tabular}
...
\begin{figure}[h!]
    ...
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t1.png} &    
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t2.png} &   
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t3.png} \\   

        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t4.png} & 
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t5.png} &   
        \includegraphics[width=0.3\textwidth]{sanity-check/needles/density-evo/equal-scale-density-t6.png} \\  
    \end{tabular}
