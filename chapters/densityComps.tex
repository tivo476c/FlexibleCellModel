...
\begin{align*}
    ...
    &= \tfrac{N_V}{2} \mathbf{1}_{\{0 < 2r\}} (2r - 0)^2 \\
    &= 2 N_V r^2,
\end{align*} 
...
\begin{align}
    \nabla_{X} \left( \psi \circ \chi \right)(X) = \mathbf{1}_{\{\norm[\vec{x}] < 2r\}} (\norm[\vec{x}] - 2r)  \begin{pmatrix}
        I_2 \\ 
        \vdots \\ 
        I_2
...
\end{align}
where $X \in \R^{2N_V}$ denotes the full cell configuration vector and $\vec{x} \in \R^2$ the cell center position extracted from $X$, such that $\norm[\vec{x}] = \chi(X)$.
