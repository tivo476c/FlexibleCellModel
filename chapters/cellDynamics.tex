...
\begin{proposition} \textbf{Partial derivatives of intersection points} \\
	...
	\begin{align}
		\begin{split}
			...
			\dfrac{\partial w(\vargs)}{\partial \vec{v}_{\text{out}}^{\: i}} = (1 - t)I_2 + (\vec{v}_{\text{in}}^{\: i} - \vec{v}_{\text{out}}^{\: i})(\nabla_{\vec{v}_{\text{out}}} t)^T,
		\end{split}
	\end{align}
	...
	\begin{align}
		\begin{split}
			...
			\dfrac{\partial w(\vargs)}{\partial \vec{v}_{\text{in}}^{\: i}} = t I_2 + (\vec{v}_{\text{in}}^{\: i} - \vec{v}_{\text{out}}^{\: i})(\nabla_{\vec{v}_{\text{in}}} t)^T.
		\end{split}
	\end{align}

	Proof.\\

	$f(\vec{v}_{\text{out}}^{\: i}, \vec{v}_{\text{out}}^{\: m}, \vec{v}_{\text{in}}^{\: m}) = \tu$ \\[1em]
	$g(\vargs) = \tl$\\[1em]
	$t(\vargs) = \dfrac{f(\vec{v}_{\text{out}}^{\: i}, \vec{v}_{\text{out}}^{\: m}, \vec{v}_{\text{in}}^{\: m})}{g(\vargs)}$ \\[1em]
	$w(\vargs) = \vec{v}_{\text{out}}^{\: i} + t(\vargs)(\vec{v}_{\text{in}}^{\: i} - \vec{v}_{\text{out}}^{\: i})$ \\[1em]
	...
	\begin{align*}
		...
		&= \dfrac{(\nabla_{\vec{v}_{\text{out}}^{\: i}} f) g - (\nabla_{\vec{v}_{\text{out}}^{\: i}} g) f}{g^2}
	\end{align*}
...
\begin{proposition} \textbf{Deforming overlap force} \\
	...
	In order to compute the gradient, we need the partial derivative $\dfrac{\partial w(\vargs)}{\partial \vec{v}_{\text{out}}^{\: i}}$.
	...
	\begin{align*}
		\dfrac{\partial w(\vargs)}{\partial \vec{v}_{\text{in}}^{\: i}} &= 
	\end{align*}
