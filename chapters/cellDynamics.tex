...
The $\atanxy(x,x)$ function computes the angle of a vector $(x,y)^T$ with respect to the positive $x$ axis. \\
...
\begin{proposition} \textbf{Interior angle force} \\
	...
	\begin{center}
		$
		\nabla_{\vec{v}_j} \arctan \left(\frac{v_{j-1}^2 - v_{j}^2}{v_{j-1}^1 - v_{j}^1} \right).
		$
	\end{center}
