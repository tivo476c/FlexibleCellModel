...
\begin{proposition} \textbf{Bounce overlap force} \label{prop:bounceForce}\\
    ...
    \begin{align*}
        \psi'(d) 
        &= \frac{\dequ}{\dequ d} \left[\frac{N_V}{2} \mathbf{1}_{[0, 2r)}(d)  (2r - d)^2\right] \\
	...
	\begin{align*}
	    \psi'(d) = N_V \mathbf{1}_{[0, 2r)}(d) (d - 2r).
	\end{align*} 
    % TODO: explain why \frac{\dequ}{\dequ d} \left[\mathbf{1}_{[0, 2r)}(d)\right] (d - 2r)^2 = 0
    Thus, 
    \begin{align*}
