...
\begin{figure}[htbp]
  \centering
  % --- top: wide figure ---
  \includegraphics[width=15cm]{forces/area1.png}\\[1ex]
  % --- bottom: left image + right caption ---
  \begin{minipage}[c]{0.35\textwidth}
    \includegraphics[width=\textwidth]{forces/energies-show-areaForce.png}
  \end{minipage}\hfill
...
\begin{figure}[htbp]
  \centering
  % --- top: wide figure ---
  \includegraphics[width=15cm]{forces/edge1.png}\\[1ex]
  % --- bottom: left image + right caption ---
  \begin{minipage}[c]{0.35\textwidth}
    \includegraphics[width=\textwidth]{forces/energies-show-edgeForce.png}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.6\textwidth}
    \caption{
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/angle1.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-show-intAngleForce.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/defOverlap1.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-show-DeformaingOverlapForce.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/bounceOverlap1.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-show-bounceOverlapForce.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
			...
			In this case, we have $\frac{\dequ \vec{v}}{\dequ t} = - 1e5 \nabla_{\vec{v}} \bar{O}_1(C_1, C_2)$ for all vertices.
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/allforces_hard.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-allforces_hard.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/allforces_0-5.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-allforces_0-5.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
...
\begin{figure}[htbp]
	\centering
	% --- top: wide figure ---
	\includegraphics[width=15cm]{forces/allforces_soft.png}\\[1ex]
	% --- bottom: left image + right caption ---
	\begin{minipage}[c]{0.35\textwidth}
		\includegraphics[width=\textwidth]{forces/energies-allforces_soft.png}
	\end{minipage}\hfill
	\begin{minipage}[c]{0.6\textwidth}
		\caption{
